...
To update the database use this command from the Web project folder (replace `todoappBE` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../todoappBE.Infrastructure/todoappBE.Infrastructure.csproj -s todoappBE.Web.csproj
```
